...
object BuildTimeConfig {
    const val APPLICATION_ID = "com.moment.app"
    const val APPLICATION_NAME = "Moment"
    ...
    val METADATA_HOST_REVERSED: String? = "com.moment.app"
    ...
    val BUG_REPORT_APP_NAME: String? = "moment-android-x"
