...
open class RoomDetailsStateProvider : PreviewParameterProvider<RoomDetailsState> {
    override val values: Sequence<RoomDetailsState>
        get() = sequenceOf(
            ...
            aRoomDetailsState(displaySecurityAndPrivacySettings = true),
...
fun aRoomDetailsState(
    ...
    displaySecurityAndPrivacySettings: Boolean = false,
    ...
    displaySecurityAndPrivacySettings = displaySecurityAndPrivacySettings,
    isPublic = isPublic,
